...
{
	gotoXY(0,10);
	cout<<"Di Chuyen Ran An Qua Chin Mau Do De Tang Diem"<<endl;
	cout<<"An Qua Xanh Se Bi Mat Diem Va Dut Than Nhe!"<<endl<<endl<<endl;
	cout<<"An Phim Bat Ki De Bat Dau Chien Nao ^^";
	_getch();
	srand(time(NULL));
	KieuSnake snake;
	QuaChin qc;
